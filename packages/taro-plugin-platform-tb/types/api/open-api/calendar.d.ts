...
declare module "@tarojs/taro" {
  ...
  interface tb {
     ...
     * 添加日历提醒
     */
    addCalendarPlan(option: tb.addCalendarPlan.Option): Promise<TqtTBGeneral.CallbackResult>;
    /**
     * 查询设置过的日历提醒
     */
     ...
     * 取消日历提醒异步接口
     */
    cancelCalendarPlan(option: tb.cancelCalendarPlan.Option): Promise<TqtTBGeneral.CallbackResult>;
  }
}
