...
declare module "@tarojs/taro" {
  ...
  interface tb {
     ...
     * 显示错误页
     */
    showErrorView(option: tb.showErrorView.Option): Promise<TqtGeneral.CallbackResult>;
    /**
     * 隐藏错误页
     */
    hideErrorView(option: tb.hideErrorView.Option): Promise<TqtGeneral.CallbackResult>;
  }
}
