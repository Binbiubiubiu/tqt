...
declare module "@tarojs/taro" {
  ...
  interface qn {
     ...
     */
    openPlugin(option: qn.openPlugin.Option): Promise<TqtQNGeneral.CallbackResult>;
    /**
     * 打开千牛插件协议槽

     */
    openCategory(option: qn.openCategory.Option): Promise<TqtQNGeneral.CallbackResult>;
    /**
     * 打开千牛改价格窗口
     *
     */
    changePrice(option: qn.changePrice.Option): Promise<TqtQNGeneral.CallbackResult>;
  }
}
